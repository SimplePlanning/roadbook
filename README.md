...
6. **手机导航**：打开路书后，顶部绿色按钮「导航全部」一键调起高德 App——第一个点为起点、最后一个点为终点、其余为途经点（高德上限 16 个途经点，超过会提示拆分）；也可以逐段点「导航」
...
- 高德导航 URI 只支持单目的地，所以逐段导航是"一段一次"形式；「导航全部」走的是高德多途经点导航，途经点上限 16 个（共 18 个点），更多点的路书需拆分或逐段导航；点名称建议写成 `D1 xxx` 便于区分
